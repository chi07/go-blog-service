...
func (m *ArticleMockService) Create(ctx context.Context, article *model.Article) error {
...
func buildMockArticle(title, description string, content []byte) *model.Article {
